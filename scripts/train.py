...
def train_for_epoch(parser, train_data, dev_data, optimizer, loss_func, batch_size):
    ...
    with tqdm(total=(n_minibatches)) as prog:
        for i, (train_x, train_y) in enumerate(minibatches(train_data, batch_size, parser.n_trans)):
...
if __name__ == "__main__":
    ...
    print("INITIALIZING")
    print(80 * "=")
    parser, embeddings, train_data, dev_data, test_data = load_and_preprocess_data(debug, mode='Train')

    with open('id2tran.pkl', 'wb') as f:
        pickle.dump(parser.id2tran, f)
